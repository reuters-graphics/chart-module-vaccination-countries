...
<script>
  ...
  // Installation docs
  const installDocs = `$ yarn add https://github.com/reuters-graphics/chart-module-vaccination-lollipop.git`;

  // JavaScript docs
  $: jsDocs = `import Chart from '@reuters-graphics/vaccination-lollipop';
...
`;
  ...
  // SCSS docs
  const styleDocs = `$VaccinationLollipop-container: '.vaccination-lollipop-container';

@import '~@reuters-graphics/vaccination-lollipop/src/scss/chart';`;
...
<div class='repo-link'>
  <a href="https://github.com/reuters-graphics/chart-module-vaccination-lollipop" target="_blank">
    <Icon icon={faGithub} />
  </a>
</div>
